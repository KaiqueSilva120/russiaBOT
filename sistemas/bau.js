...
> RG: ${rg}`)
        ...
        },
        {
            ...
            async execute(interaction) {
                ...
                saveJSON(bauFilePath, bauData);
                await interaction.reply({ content: `O saldo do item '${itemName}' foi redefinido com sucesso!`, ephemeral: true });
        ...
        },
        {
            ...
            async execute(interaction) {
                ...
                await interaction.reply({ content: '<a:like1:1369644902010458143> O baú e todo o histórico de movimentações foram limpos!!', ephemeral: true });
